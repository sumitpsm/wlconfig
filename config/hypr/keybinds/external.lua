...
hl.bind(main_mod .. " + Return", hl.dsp.exec_cmd("kitty zellij options --session-serialization false --on-force-close quit"))
hl.bind(main_mod .. " + SHIFT + Return", hl.dsp.exec_cmd("alacritty"))
...
hl.bind(main_mod .. " + Tab", hl.dsp.exec_cmd("XDG_DATA_DIRS=\"$XDG_DATA_DIRS:/usr/share:/usr/local/share\" fuzzel"))
...
hl.bind(main_mod .. " + SHIFT + R", hl.dsp.exec_cmd("hyprpicker | wl-copy"))
